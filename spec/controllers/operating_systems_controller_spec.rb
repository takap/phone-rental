...
describe OperatingSystemsController do
  ...
  let(:valid_attributes) { { "version_name" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved operating_system as @operating_system" do
        ...
        post :create, {:operating_system => { "version_name" => "invalid value" }}, valid_session
        assigns(:operating_system).should be_a_new(OperatingSystem)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested operating_system" do
        ...
        OperatingSystem.any_instance.should_receive(:update).with({ "version_name" => "MyString" })
        put :update, {:id => operating_system.to_param, :operating_system => { "version_name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the operating_system as @operating_system" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        OperatingSystem.any_instance.stub(:save).and_return(false)
        put :update, {:id => operating_system.to_param, :operating_system => { "version_name" => "invalid value" }}, valid_session
        assigns(:operating_system).should eq(operating_system)
      end
