  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved carrier as @carrier" do
        ...
        post :create, {:carrier => { "name" => "invalid value" }}, valid_session
        assigns(:carrier).should be_a_new(Carrier)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested carrier" do
        ...
        Carrier.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => carrier.to_param, :carrier => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the carrier as @carrier" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Carrier.any_instance.stub(:save).and_return(false)
        put :update, {:id => carrier.to_param, :carrier => { "name" => "invalid value" }}, valid_session
        assigns(:carrier).should eq(carrier)
      end
