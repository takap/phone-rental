class Terminal < ActiveRecord::Base
  ...
  def self.find_details_by_category category
    hash = ActiveRecord::Base.connection.select(<<-SQL
        SELECT terminal_id, terminal_name, terminal_master_id, volume, phone_number, wifi, carrier_id, maker_id, category_id, group_id, model_name, default_os, updated_os, screen_inch, screen_width, screen_height, screen_density_id, release_date, tablet, nfc, carrier_name, maker_name, f.name group_name FROM (
        SELECT terminal_id, terminal_name, terminal_master_id, volume, phone_number, wifi, carrier_id, maker_id, category_id, group_id, model_name, default_os, updated_os, screen_inch, screen_width, screen_height, screen_density_id, release_date, tablet, nfc, carrier_name, d.name maker_name FROM (
        SELECT terminal_id, terminal_name, terminal_master_id, volume, phone_number, wifi, carrier_id, maker_id, category_id, group_id, model_name, default_os, updated_os, screen_inch, screen_width, screen_height, screen_density_id, release_date, tablet, nfc, b.name carrier_name FROM (
